...
ALTER TABLE `shippingaddressmapper` ADD COLUMN `address_order` INT(1) AFTER `shippingaddresses_shippingaddressID`;
UPDATE `shippingaddressmapper` SET `address_order`= 1 WHERE 1;
